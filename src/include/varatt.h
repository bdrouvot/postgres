...
#define VARDATA_4B(PTR)		(((const varattrib_4b *) (PTR))->va_4byte.va_data)
#define VARDATA_4B_C(PTR)	(((const varattrib_4b *) (PTR))->va_compressed.va_data)
#define VARDATA_1B(PTR)		(((const varattrib_1b *) (PTR))->va_data)
